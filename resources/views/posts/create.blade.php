<x-layout>
    ...
    <div class="container mt-4 mx-auto mt-8">
        ...
        <div class="text-center">
            <h1 class="my-3 text-3xl font-bold text-black">Create Post</h1>
        </div>
                ...
                <div class="mb-8">
                    ...
                    <select name="category_id" id="category" class="w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
                        ...
                        @foreach($categories as $category)
                            <option class="@if($category->is_active == 0) hidden @endif" value="{{$category->id}}">{{$category->name}}</option>
                        @endforeach
    ...
    @push("scripts")
        ...
        <script>
            ...
            $('#summernote').summernote({
                focus: true, height: 400,  disableResizeEditor: true
            });
